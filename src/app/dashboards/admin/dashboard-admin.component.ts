...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, AdminTalleresComponent, AdminGananciasComponent, AdminServiciosComponent, AdminReportesComponent, AdminKpisComponent],
  templateUrl: './dashboard-admin.component.html',
  styleUrl: './dashboard-admin.component.scss'
})
export class DashboardAdminComponent implements OnInit {
  currentUser: User | null = null;
  vistaActual: 'inicio' | 'talleres' | 'ganancias' | 'servicios' | 'reportes' | 'kpis' = 'inicio';
  statsLoading = false;
  ...
  handleAction(action: string): void {
    ...
    const mapa: Record<string, 'talleres' | 'ganancias' | 'servicios' | 'reportes' | 'kpis'> = {
      talleres: 'talleres',
      ganancias: 'ganancias',
      servicios: 'servicios',
      reportes: 'reportes',
